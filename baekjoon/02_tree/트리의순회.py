...
pst = sys.stdin.readline().split()
pre = ['0']*N

def find_pre(x,y, a,b, c,d):
    global ino, pst, pre
    # ino [x:y]
    # pst [a:b]
    # pre [c:d]
    ...
    # left
    if l_len:
        find_pre(x,ino_root-1, a,a+l_len-1, c+1,c+l_len)
    # right
    if r_len:
        find_pre(ino_root+1,y, a+l_len,b-1, d-r_len+1,d)

find_pre(0,N-1,0,N-1,0,N-1)
print(*pre)
